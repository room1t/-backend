package se.sowl.roomitapi.oauth.factory;
...
import se.sowl.roomitdomain.oauth.domain.OAuth2Profile;
import se.sowl.roomitdomain.oauth.domain.OAuth2UserAttribute;
import se.sowl.roomitdomain.oauth.domain.Role;
